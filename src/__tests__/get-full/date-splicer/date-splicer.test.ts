...
describe('test date splicer function', () => {
      ...
      it('date splicer functional test 7', () => {
            expect(dateSplicer('1339/9/09')).toStrictEqual({
                  year: 1339,
                  month: 9,
                  day: 9,
                  hour: 0,
      ...
      it('date splicer functional test 8', () => {
            expect(dateSplicer('1339/9/09T23:11:12.30')).toStrictEqual({
                  year: 1339,
                  month: 9,
                  day: 9,
                  hour: 23,
