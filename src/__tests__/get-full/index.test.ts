...
//============================================================================================================================================================================================================================================================================================================================================
      ...
      it('functional test 11', () => {
            let { year, month, day, hour, minute, second, millisecond } = getFull('1371/08/26T20:30:0.000Z', 'en');
      ...
      it('functional test 12', () => {
            let { year, month, day } = getFull('1398-8-25', 'en');
      ...
      it('functional test 15', () => {
            let { year, month, day, hour, minute, second, millisecond } = getFull('1373_2_4T1994/04/24', 'en');
      ...
      it('functional test 16', () => {
            let { year, month, day } = getFull('1375 3 27', 'en');
      ...
      it('functional test 17', () => {
            let { year, month, day } = getFull('1398\\3\\26', 'en');
            expect(year).toBe(2019);
            expect(month).toBe(6);
            expect(day).toBe(16);
      });
