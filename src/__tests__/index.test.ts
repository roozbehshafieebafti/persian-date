...
//=================================================================================================================================================================================================================================================================================================================================================================================================
      ...
      test('has isPersianLeap method?', () => {
            expect('isPersianLeap' in _date).toBe(true);
      });      
      
      test('has isGregorianLeap method?', () => {
            expect('isGregorianLeap' in _date).toBe(true);
      });      
...
//                                                                                                                                                                                                                                                                                                                                                                      
//======================================================================================================================================================================================================================================================================================================================================================================
      test('functional test get day name 1 ', () => {
            let name= _date.getDayName('2020-10-29T17:59:0.000Z','fa');
            expect(name).toBe('پنج‌شنبه');
      });

      test('functional test get day name 1 ', () => {
            let name= _date.getDayName('1399_08_08T17:59:0.000Z','en');
...
//================================================================================================================================================================================================================================================================================================
      ...
      test('functional test is Persian Leap  ', () => {
            expect(_date.isPersianLeap(1391)).toBe(true);
            expect(_date.isPersianLeap(1390)).toBe(false);
      });

      test('functional test is Gregorian Leap ', () => {
            expect(_date.isGregorianLeap(2016)).toBe(true);
            expect(_date.isGregorianLeap(1992)).toBe(true);
            expect(_date.isGregorianLeap(2010)).toBe(false);
      });
});
